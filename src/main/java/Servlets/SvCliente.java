...
public class SvCliente extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            Cliente clienteBaseDatos = clienteDAO.buscarClientePorEmailYCorreoLogin(loginRequest.getCorreoElectronico(), loginRequest.getContrasena());

            if (loginRequest != null && loginRequest.equals(clienteBaseDatos)) {
                // Si el cliente existe y las credenciales son correctas
                response.setStatus(HttpServletResponse.SC_OK);
                response.setContentType("application/json");
                response.getWriter().write(objectMapper.writeValueAsString(clienteBaseDatos));
            } else {
                //Si el cliente no existe se crea
                clienteDAO.persistirEntidad(loginRequest);
    ...
    protected void doPut(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            clienteExistente.setComengarios(cliente.getComengarios());
            clienteDAO.actualizarEntidad(clienteExistente);
